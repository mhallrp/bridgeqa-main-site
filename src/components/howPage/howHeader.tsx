...
const HowHeader = () => {
    return (
        <div className="flex flex-col gap-8 sm:gap-0 sm:flex-row sm:py-24 justify-between items-center">
            <div className="flex flex-col gap-8 sm:gap-0 lg:w-[38.65%] h-full text-center sm:text-left">
                <span className="px-4 py-2 text-white font-bold text-sm bg-[linear-gradient(to_right,_#0090FF_0%,_#7D00FF_86%,_#A600FF_100%)] rounded-lg w-auto self-start hidden sm:block">
                    How it works
                </span>
            ...
            <div className="flex w-full sm:w-[53.45%] h-full mb-8 sm:mb-0">
